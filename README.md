# EVRPTW-FSL Benchmark Instances

The data support the findings of the EVRPTW-FSL problem study.
...
6. `capacity`: Maximum number of customers that can be served at this service location. For the depot and charging stations, this value is set to `0`.
7. `serving_customers`: List of customers that can be served at this location. For the depot and charging stations, this list is empty.
